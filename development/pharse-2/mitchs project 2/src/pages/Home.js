...
function Home() {
    // Get firstName from the location state passed from Contact page
    const location = useLocation();
    const { firstName } = location.state || {}; // Use default value if not available
                    ...
                    <div className="row">
                        <div className="col-sm-6 d-flex d-sm-block flex-column align-items-center">
                            ...
                            <h1 className="mb-5 text-black fw-bold text-center text-sm-start">
                                {firstName ? ` Nelhard Restaurant, ${firstName}!` : 'Nelhard Restaurant'}
                            </h1>
                            <MenuBtn />
                        </div>
                    </div>
                        ...
                        <div className="col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0">
                            ...
                            <ul className="px-0">
                                <li className="d-flex justify-content-between">
                                    ...
                                    <p className="fs-3 mx-2 text-success fw-nold">Ksh 1800</p>
                                </li>
                                <li className="d-flex justify-content-between">
                                    <p className="fs-3 mx-2">Spicy Beef</p>
                                    <p className="fs-3 mx-2 text-success fw-nold">Ksh 2000</p>
                                </li>
                                <li className="d-flex justify-content-between">
                                    <p className="fs-3 mx-2">Saghetti Bolognese</p>
                                    <p className="fs-3 mx-2 text-success fw-nold">Ksh 2200</p>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0">
                            ...
                            <ul className="px-0">
                                <li className="d-flex justify-content-between">
                                    ...
                                    <p className="fs-3 mx-2 text-success fw-nold">ksh400</p>
                                </li>
                                <li className="d-flex justify-content-between">
                                    <p className="fs-3 mx-2">Juice</p>
                                    <p className="fs-3 mx-2 text-success fw-nold">ksh130</p>
                                </li>
                                <li className="d-flex justify-content-between">
                                    <p className="fs-3 mx-2">Spirits</p>
                                    <p className="fs-3 mx-2 text-success fw-nold">Ksh 700</p>
                                </li>
                            </ul>
                        </div>
                    </div>
